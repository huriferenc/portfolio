export const SKILL_ICONS = {
  angular: '<i title="Angular" class="fa-brands fa-angular fa-fw"></i>',
  rxjs: '<img title="RxJs" src="./assets/img/rxjs.svg" />',
  ts: '<img title="TypeScript" src="./assets/img/ts.svg" />',
  sass: '<i title="Sass" class="fa-brands fa-sass fa-fw"></i>',
  codeigniter: '<img title="CodeIgniter" src="./assets/img/codeigniter.svg" />',
